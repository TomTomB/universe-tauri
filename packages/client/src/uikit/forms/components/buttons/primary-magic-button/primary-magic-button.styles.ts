import { AnimatedBorderOverlay } from '@universe/client/uikit/common/components';
import magicButtonLeftRunes from './assets/images/magic-button-left-runes-44x22-29f30f29f.png';
import magicButtonRightRunes from './assets/images/magic-button-right-runes-62x22-25f30f29f.png';
import styled, { keyframes } from 'styled-components';

export const backgroundIntroAnimation = keyframes`
0% {
...
export const runeMagicLeftSpriteSheetAnimation = keyframes`
0% {
...
export const runeMagicRightSpriteSheetAnimation = keyframes`
0% {
...
export const radialEffectAnimation = keyframes`
 0% {
  top: -120px;
}
100% {
...
export const StyledAnimatedBorderOverlay = styled(AnimatedBorderOverlay)`
  display: block;
  position: absolute;
  opacity: 0.01;
...
export const FrameBase = styled.div`
  display: block;
  position: absolute;
  width: 100%;
  height: 100%;
...
export const FrameIdle = styled(FrameBase)`
  opacity: 1;
  &::before,
  &::after {
    transition: 300ms all linear;
...
export const FrameInteractive = styled(FrameBase)`
  opacity: 0;
  &::before,
  &::after {
    transition: 300ms all linear;
...
export const RuneBase = styled.div`
  position: absolute;
  pointer-events: inherit;
  background-repeat: no-repeat;
`;

export const LeftRuneMagic = styled(RuneBase)`
  width: 44px;
  height: 22px;
  left: 0;
  bottom: 0;
...
export const RightRuneMagic = styled(RuneBase)`
  width: 62px;
  height: 22px;
  right: 0;
  top: 0;
